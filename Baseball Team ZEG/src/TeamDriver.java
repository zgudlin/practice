...
public class TeamDriver
{
    ...
    **********************************************************/
    ...
    static Library myLib = new Library();  //Has methods to clear/pause screen
	...
	**********************************************************/
	...
	public static void playerInfo (Team team)
	{
		...
		else
		{
			...
			bats = Keyboard.readInt();

			//Input # of hits
			System.out.print ("\n" + Util.setLeft (35, "Hits   : "));
			hits = Keyboard.readInt();
